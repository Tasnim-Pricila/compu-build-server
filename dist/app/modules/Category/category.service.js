...
exports.getCategoryService = exports.getCategoryByNameService = exports.getCategoryByIdService = exports.createCategoryService = void 0;
...
const getCategoryByNameService = (name) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_model_1.Category.findOne({ name });
    // console.log(result);
    return result;
});
